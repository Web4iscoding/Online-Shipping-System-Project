...
const CustomerAccountDetails = () => {
  ...
  const onUpdateAccount = async (e) => {
    ...
    const { shippingAddress1, shippingAddress2, shippingAddress3 } = formData;
    const payload = {
      username,
      shippingAddress1,
      shippingAddress2,
  ...
  return (
    <div className="customer-account-details-container">
      ...
      <div className="customer-account-details-content">
        ...
        <div>
          <h3>Profile Image</h3>
          <img
            className="customer-account-details-avatar"
            src={
              photoPreview
                ? photoPreview
          ...
          />
          <button
            id="customer-account-details-edit"
        ...
        {showEdit[0] && (
          <div>
            ...
            <form onSubmit={onUpdate}>
              ...
              <button type="submit" id="customer-account-details-save">
                Save
              </button>
              <button
                type="button"
